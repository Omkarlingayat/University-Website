...
<!------------------------------ header --------------------------->
        ...
        <section style="background-color: rgb(67, 138, 138); width: 2000px; height: 80px;">
            <nav>
                <a href="index.html">
...
<%          
                ...
                while(rs.next()){
                    ...
                    out.println("<tr><td>"+rs.getString("email")+"</td>");
...
%>
            ...
            <br><br>
            <h3>Enroll Studnet</h3>
            <br><br>
            <form action="EnrollStuent.jsp">
                <div >
                    <div style="align-items: center;">
                        <label style="margin-left: 200px; font-family: 'Courier New', Courier, monospace;">Email</label>
                        <input type="text" name="t1" style="margin-left: 10px;height: 30px; width: 300px; border-radius:  0.5rem; padding-left: 10px;">
                        <label style="margin-left: 50px; font-family: 'Courier New', Courier, monospace;">Password</label>
                        <input type="text" name="t2" style="margin-left: 10px;height: 30px; width: 300px; border-radius:  0.5rem; padding-left: 10px;">
                        <input type="submit" value="Submit" style="height: 30px; width: 100px; background-color: yellowgreen; color: white; cursor: pointer; border-radius: 0.5rem; margin-left: 50px;" >
                    </div>
                </div>
            </form>
<%
